    ...
    AutomationCompatibleInterface
{
    ...
    // governance
    uint8 public platformFeePercent = 0; // X% - to platform
    uint8 public founderFeePercent = 0; // Y% - to founder
    uint8 public winnerFeePercent = 100; // Z% - to winner

    // fee recipients
    address public platformAddress;
    address public founderAddress;

    // only timelock can modify parameters above
